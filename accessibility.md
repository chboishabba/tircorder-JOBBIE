...
- Labels expose expanded/collapsed state, describe their controls, and receive visible focus outlines.
- The current transcript line is mirrored into an `aria-live` region to announce dynamic updates.
